...
model_path = "/Users/sunyihuan/Desktop/parameters/orans_eyebrow_width/95.58/model.ckpt-17"
saved_model_path = "/Users/sunyihuan/PycharmProjects/myself/DeltaLab/serving_learning/meikuan_saved_model"
...
def main():
    with hair_length_graph.as_default():
        ...
        builder = tf.saved_model.builder.SavedModelBuilder(
            os.path.join(saved_model_path, str(1)))
