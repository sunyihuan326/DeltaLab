...
def get_point_feature():
    print('开始{}导入'.format('lip'))
    dir_path = os.listdir('material/cartoon/lip/model')
    m = 20
    n = 14
    ...
    for i, sourceDir in enumerate(dir_path):
        ...
        full_path = 'material/cartoon/lip/model/' + sourceDir
        ...
        print('load--->{}---图{}'.format('lip', _id))
    scio.savemat('material/feature_matrix/lip', {"X": X, "Y": Y})
    print('完成{}导入'.format('lip'))
