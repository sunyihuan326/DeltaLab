...
def compute_layer_style_cost(a_S, a_G):
    ...
    J_style_layer = 1.0 / (4 * pow(n_C, 2) * pow(n_W * n_H, 2)) * \
                    tf.reduce_sum(tf.square(GS - GG))
...
def model_nn(sess, input_image, num_iterations=200):
    ...
    for i in range(num_iterations):
        ...
        if i % 20 == 0:
            ...
            save_image("test_picture/" + str(i) + ".png", generated_image)

    # save last generated image
    save_image('test_picture/generated_image.jpg', generated_image)
