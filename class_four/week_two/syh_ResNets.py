...
from class_four.week_two.resnets_utils import *
...
def identity_block(X, f, filters, stage, block):
    ...
    X = Conv2D(filters=F1, kernel_size=(1, 1), strides=(1, 1), padding='valid', name=con_name_base + '2a',
...
def ResNets_Model(input_shape=(64, 64, 3), classes=6):
...
model = ResNets_Model(input_shape=(64, 64, 3),classes = 6)
